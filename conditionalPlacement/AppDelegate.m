...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    int leornardPlace = leonard > 7 ? 1 : 2;
    
    
    
    if (leornardPlace == 1 && karlPlace == 1) {
        
        NSLog(@"Both teachers are placed 1");
        
    }
    
    else if (karlPlace == 1 && leonard > 1) {
        
        NSLog(@"Karl is placed 1 and Leonard is placed 2");
        
    }
    
    else if (karlPlace > 1 && leornardPlace == 1) {
